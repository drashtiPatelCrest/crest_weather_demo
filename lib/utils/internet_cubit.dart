...
class InternetCubit extends Cubit<InternetState> {
  ...
  void emitInternetConnected(ConnectionType connectionType) =>
      emit(state.copyWith(connectionType: connectionType, status: InternetStatusState.connected));

  void emitInternetDisconnected() => emit(state.copyWith(connectionType: ConnectionType.None, status: InternetStatusState.disconnected));
